...
func init() {
	...
	// usagelogDescImageRequestedSize is the schema descriptor for image_requested_size field.
	usagelogDescImageRequestedSize := usagelogFields[35].Descriptor()
	// usagelog.ImageRequestedSizeValidator is a validator for the "image_requested_size" field. It is called by the builders before save.
	usagelog.ImageRequestedSizeValidator = usagelogDescImageRequestedSize.Validators[0].(func(string) error)
