...
var (
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "image_requested_size", Type: field.TypeString, Nullable: true, Size: 32},
		{Name: "image_prompt", Type: field.TypeString, Nullable: true, Size: 2147483647},
		{Name: "image_revised_prompt", Type: field.TypeString, Nullable: true, Size: 2147483647},
