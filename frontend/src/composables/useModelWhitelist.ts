...
const openaiPresetMappings = [
  ...
  { label: 'GPT-5.1 Codex Mini', from: 'gpt-5.1-codex-mini', to: 'gpt-5.1-codex-mini', color: 'bg-cyan-100 text-cyan-700 hover:bg-cyan-200 dark:bg-cyan-900/30 dark:text-cyan-400' },
...
export function getPresetMappingsByPlatform(platform: string) {
  if (platform === 'openai') return openaiCuratedPresetMappings
