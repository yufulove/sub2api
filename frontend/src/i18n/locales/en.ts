export default {
  ...
  version: {
    ...
    upstreamUpdateAvailable: 'A newer upstream release is available',
    ...
    sourceModeHint: 'Source build detected. Review upstream changes before using git pull to update.',
