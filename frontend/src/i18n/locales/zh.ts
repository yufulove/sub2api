export default {
  ...
  keys: {
    ...
    useKeyModal: {
      ...
      groupType: '分组类型',
      rateMultiplier: '费率倍数',
      recommendedClient: '推荐客户端',
      recommendedModel: '推荐模型',
      remainingQuota: '剩余额度',
      unlimited: '无限制',
      rateLimitValue: '{window}: {limit}（已用 {used}）',
      modelChangeHint: '下方模板只是起始配置，模型名可以按你的实际需求替换。',
      recommendations: {
        openai: '默认先用 {client}，初始模型建议填 {model}。WebSocket 标签属于高级模式。',
        openaiWithClaude: '默认先用 {client}，初始模型建议填 {model}。下方也提供 Claude Code 兼容接入，WebSocket 标签属于高级模式。',
        gemini: '如果这把 key 主要用于文本、图片或 PDF 理解，建议先用 {client}，默认模型保持 {model}。',
        antigravity: '默认先用 {client}，初始模型建议填 {model}。如果你更习惯 Gemini CLI，也可以在下方切换。',
        default: '建议先用 {client}，初始模型可先用 {model}。'
      },
      openai: {
  ...
  admin: {
    ...
    accounts: {
      ...
      types: {
        ...
        soraApiKeyHint: '连接另一个 FionaAI 或兼容 API',
      ...
      testModel: '测试模型',
      testPrompt: '提示词："hi"',
      soraUpstreamBaseUrlHint: '上游 Sora 服务地址（另一个 FionaAI 实例或兼容 API）',
    ...
    settings: {
      ...
      linuxdo: {
        ...
        description: '配置 LinuxDo Connect OAuth，用于 FionaAI 用户登录',
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 欢迎使用 FionaAI',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">FionaAI 是一个强大的 AI 服务中转平台，让您轻松管理和分发 AI 服务。</p><p style="margin-bottom: 12px;"><b>🎯 核心功能：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>分组管理</b> - 创建不同的服务套餐（VIP、免费试用等）</li><li>🔗 <b>账号池</b> - 连接多个上游 AI 服务商账号</li><li>🔑 <b>密钥分发</b> - 为用户生成独立的 API Key</li><li>💰 <b>计费管理</b> - 灵活的费率和配额控制</li></ul><p style="color: #10b981; font-weight: 600;">接下来，我们将用 3 分钟带您完成首次配置 →</p></div>',
        nextBtn: '开始配置 🚀',
        prevBtn: '跳过'
      },
      groupManage: {
        title: '📦 第一步：分组管理',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>什么是分组？</b></p><p style="margin-bottom: 12px;">分组是 FionaAI 的核心概念，它就像一个"服务套餐"：</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 每个分组可以包含多个上游账号</li><li>💰 每个分组有独立的计费倍率</li><li>👥 可以设置为公开或专属分组</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 示例：</b>您可以创建"VIP专线"（高倍率）和"免费试用"（低倍率）两个分组</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 点击左侧的"分组管理"开始</p></div>'
      },
      createGroup: {
        title: '➕ 创建新分组',
        description:
    ...
    user: {
      welcome: {
        title: '👋 欢迎使用 FionaAI',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">您好！欢迎来到 FionaAI AI 服务平台。</p><p style="margin-bottom: 12px;"><b>🎯 快速开始：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 创建 API 密钥</li><li>📋 复制密钥到您的应用</li><li>🚀 开始使用 AI 服务</li></ul><p style="color: #10b981; font-weight: 600;">只需 1 分钟，让我们开始吧 →</p></div>',
        nextBtn: '开始 🚀',
        prevBtn: '跳过'
      },
      keyManage: {
